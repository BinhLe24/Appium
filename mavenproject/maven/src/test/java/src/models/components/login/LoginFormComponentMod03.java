...
public class LoginFormComponentMod03 {
    ...
    private static final By loginSuccessPopupSel = MobileBy.id("android:id/alertTitle");
    ...
    public String loginButtonPopup(){
        return appiumDriver.findElement(loginSuccessPopupSel).getText();
    }
}
