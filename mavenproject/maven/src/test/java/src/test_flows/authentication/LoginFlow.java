...
//        Verifier.equals(1,2)
//        Assert.assertTrue(actualInvalidEmailTxt.equalsIgnoreCase(expectedInvalidEmailTxt),"[ERR] message");
        Assert.assertEquals(actualInvalidEmailTxt, expectedInvalidEmailTxt,"[ERR] message");
